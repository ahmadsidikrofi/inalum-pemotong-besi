                                    ...
                                    <div class="card-body p-4">
                                        ...
                                        <div class="table-responsive">
                                            <table class="table text-nowrap mb-0 align-middle">
                                                ...
                                                <tbody>
                                                @php $x = 1 @endphp
                                                    @foreach ( $billetStacker as $billetOrder )
                                                            ...
                                                            <form method="post" action="/confirm-sawing-billet/{{ $billetOrder->id }}" >
                                                                ...
                                                                <td class="border-bottom-0">
                                                                    <select style="width: 160px" name="status" id="status" class="form-control rounded-3 text-center p-2">
                                                                        <option  @if ($billetOrder->status === "selesai") selected @endif value="selesai">Menunggu Diangkut</option>
                                                                    ...
                                                                    <button type="submit" class="btn btn-primary rounded-3 mt-3">Konfirmasi Pengangkutan</button>
                                                                </td>
                                                            </form>
